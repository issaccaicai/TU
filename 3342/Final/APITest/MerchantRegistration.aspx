<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MerchantRegistration.aspx.cs" Inherits="APITest.MerchantRegistration" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 register-left">
                        ...
                        <div class="text-success">
                            <h3>Welcome to Merchant Registration Page!</h3>
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6" style="text-align: left;">
                                        <div class="form-group">
                                            <br />
                                            <label>Seller Site:</label>
                                            <br />
                                            <asp:TextBox runat="server" ID="txtSellerSite" class="form-control" placeholder="Seller Site *" value="" />
                                        </div>
                                        <div class="form-group">
                                            <br />
                                            <label>URL:</label>
                                            <br />
                                            <asp:TextBox runat="server" ID="txtUrl" class="form-control" placeholder="Url *" value="" />
                                        </div>
                                        <div class="form-group">
                                            <br />
                                            <label>Email:</label>
                                            <br />
                                            <asp:TextBox runat="server" ID="txtEmail" class="form-control" placeholder="Email *" value="" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>Phone:</label>
                                            <br />
                                            <asp:TextBox runat="server" ID="txtPhone" minlength="10" MaxLength="10" class="form-control" placeholder="Phone *" value="" />
                                        </div>
                                        <div class="form-group">
                                            <br />
                                            <label>Description:</label>
                                            <br />
                                            <asp:TextBox runat="server" ID="txtDescription" class="form-control" placeholder="Description *" value="" />
                                        </div>
                                        <div class="form-group">
                                            <br />
                                            <label>Address:</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group"  style="text-align:left;">
                                            ...
                                            <asp:TableCell runat="server" >
                                                ...
                                                <asp:ListItem>What is the color of your eyes?</asp:ListItem>
                                                </asp:DropDownList>
                                            </asp:TableCell>
                                        </div>
                                        ...
                                        <div class="form-group"  style="text-align:left;">
                                            ...
                                            <asp:TableCell runat="server" >
                                                ...
                                                <asp:ListItem>In what county where you born?</asp:ListItem>
                                                <asp:ListItem>Where did you vacation last year?</asp:ListItem>
                                                <asp:ListItem>What is your preferred musical genre?</asp:ListItem>
                                                </asp:DropDownList>
                                            </asp:TableCell>
                                        </div>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group"  style="text-align:left;">
                                            ...
                                            <asp:TableCell runat="server" >
                                                ...
                                                <asp:ListItem>What was your hair color as a child?</asp:ListItem>
                                        ...
                                        <asp:Button ID="btnRegister" class="btnRegister" runat="server" Text="Register" style="float:right;" OnClick="btnRegister_Click"></asp:Button>
